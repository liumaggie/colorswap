...
class Triangle extends Obstacle {
  constructor(centerX, centerY, radius, color) {
    ...
    this.lines = [
      new Line(this.x, this.y, this.radius, 0, 2*Math.PI/3, this.selectedColors[0]),
      new Line(this.x, this.y, this.radius, 2*Math.PI/3, 4*Math.PI/3, this.selectedColors[1]),
      new Line(this.x, this.y, this.radius, 4*Math.PI/3, 0, this.selectedColors[2]),
    ];
  }

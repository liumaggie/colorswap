...
const Arc = __webpack_require__(3);
const Util = __webpack_require__(0);
const Line = __webpack_require__(2);
...
class Arc {
  ...
  collision(player, spinner) {
    ...
    this.yAtCircleBottom =
      Util.pointOnCircle(this.center, this.radius, Math.PI/2)[1];
    this.yAtCircleTop =
      Util.pointOnCircle(this.center, this.radius, 3*Math.PI/2)[1];
  ...
  draw(ctx, spinner) {
    ...
    if (spinner) {
      ctx.arc(this.center[0], this.center[1],
              this.radius, this.start, this.end, true);
      ctx.lineWidth = 10;
    } else {
      ctx.arc(this.center[0], this.center[1],
              this.radius, this.start, this.end, true);
...
class Circle extends Shape {
  ...
  createArc(start, end, color) {
    return new Arc(this.x, this.y,
                   this.radius, start, end, color, this.rotatingAngle);
  }
...
const Shape = __webpack_require__(1);
const Rectangle = __webpack_require__(12);
const Circle = __webpack_require__(4);
const Triangle = __webpack_require__(14);
const DoubleCircle = __webpack_require__(10);
const ColorSpinner = __webpack_require__(9);
const Star = __webpack_require__(13);
const LineObstacle = __webpack_require__(11);
const Util = __webpack_require__(0);
...
class GameView {
  constructor(game, ctx) {
    ...
    this.removeGameEventListeners = this.removeGameEventListeners.bind(this);
  ...
  createNewGame() {
    ...
    window.removeEventListener("mousedown", this.createNewGame);
  }
  ...
  lossSplash() {
    ...
    this.ctx.fillText('Click or Press R to restart the game', Game.width/5 - 60, Game.height/2 + 60);
    window.addEventListener('keydown', this.checkKeyForRestart);
    window.addEventListener('mousedown', this.createNewGame);
  }
